...
namespace LeetCodeCSharp
{
    ...
    public class Ex060Test
    {
        ...
        [TestMethod]
        public void LeetCode_Ex060_Test_RotateRight5()
        {
            ListNode l1 = new ListNode(1);
            ListNode l2 = new ListNode(2);
            ListNode l3 = new ListNode(3);
            ...
            ListNode r = Ex060.RotateRight2(l1, 2);
            Assert.AreEqual(4, r.Val);
            r = r.Next;
            Assert.AreEqual(5, r.Val);
        }
        ...
        [TestMethod]
        public void LeetCode_Ex060_Test_RotateRight6()
        {
            ListNode l1 = new ListNode(1);

            ListNode r = Ex060.RotateRight2(l1, 1);
            Assert.AreEqual(1, r.Val);
        }

        [TestMethod]
        public void LeetCode_Ex060_Test_RotateRight7()
        {
            ListNode l1 = new ListNode(1);
            ListNode l2 = new ListNode(2);
            ListNode l3 = new ListNode(3);
            ...
            ListNode r = Ex060.RotateRight2(l1, 5);
            Assert.AreEqual(1, r.Val);
            r = r.Next;
            Assert.AreEqual(2, r.Val);
        }
        ...
        [TestMethod]
        public void LeetCode_Ex060_Test_RotateRight8()
        {
            ListNode l1 = new ListNode(1);
            ListNode l2 = new ListNode(2);
            ListNode l3 = new ListNode(3);
